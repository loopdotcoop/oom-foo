...
VERSION:"1.2.15",HOMEPAGE:"http://oom-foo.loop.coop/",
...
;if(!t[r]||!t[r].name)throw TypeError(n+e.name+"’s value has no "+r+".name")
...
normaliseSchema:function(e,t,r){var a={}
;for(var o in r)for(var i in a[o]={},r[o]){
var s="KIT.normaliseSchema: "+i+"’s ",u=r[o][i],l=a[o][i]={}
...
return t&&(a.stat=Object.assign({},t.schema.stat,a.stat),a.attr=Object.assign({},t.schema.attr,a.attr)),
a}},t)
...
return n.normaliseSchema(Oom,null,{stat:{NAME:"Oom",
...
}}),r.devMainVue=function(t){return{
template:r.devMainVueTemplate,data:function(){return{
schema:t.schema,stat:t.stat,attr:(new t).attr,ui:{hideData:!1,
hideInners:!1}}},methods:{},beforeCreate:function(){
var e=n,t=e.isReadWrite,a=e.isReadOnly,o=e.isConstant,i=e.stringOrName
...
methods:{isReadWrite:t,isReadOnly:a,isConstant:o,stringOrName:i}
})},created:function(){n.wrapReadOnly(e.Oom.stat)}}
},r.KIT=n,r.Foo=function(e){
return $traceurRuntime.createClass(function $__1(){
$traceurRuntime.superConstructor($__1).apply(this,arguments)
},{},{get schema(){return n.normaliseSchema(r.Foo,r,{stat:t,
attr:{}})}},e)
}(r),n.name(r.Foo,"Oom.Foo"),r.Foo.stat={},n.define(r.Foo.stat,r.Foo.schema.stat),
r.Foo.prototype.attr={},
n.define(r.Foo.prototype.attr,r.Foo.schema.attr)
}("object"===("undefined"==typeof global?"undefined":$traceurRuntime.typeof(global))?global:this),
function(e){var t=e.Oom,n=t.KIT,r=t.Foo.Post=function(e){
...
n.define(t.Foo.Post.stat,t.Foo.Post.schema.stat),
t.Foo.Post.prototype.attr={},n.define(t.Foo.Post.prototype.attr,t.Foo.Post.schema.attr)
}("object"===("undefined"==typeof global?"undefined":$traceurRuntime.typeof(global))?global:this),
function(e){var t=e.Oom,n=t.KIT,r=t.Foo.Router=function(e){
return $traceurRuntime.createClass(function $__0(){
var e=void 0!==arguments[0]?arguments[0]:{}
;$traceurRuntime.superConstructor($__0).call(this,e)},{},{
...
n.define(t.Foo.Router.stat,t.Foo.Router.schema.stat),
t.Foo.Router.prototype.attr={},
n.define(t.Foo.Router.prototype.attr,t.Foo.Router.schema.attr)
}("object"===("undefined"==typeof global?"undefined":$traceurRuntime.typeof(global))?global:this);
