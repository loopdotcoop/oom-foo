...
VERSION:"1.2.20",HOMEPAGE:"http://oom-foo.loop.coop/",
...
attr:function(e,t){return n.define.constant.any(e,t)},
any:function(e,t){return Object.defineProperty(e,t.name,{
value:t.default,configurable:!1,enumerable:!0,writable:!1})}},
readOnly:{stat:function(e,t){var a=t.perClass?e:t.definedIn.stat
...
;for(var r in t)for(var o in a[r]={},t[r]){
var i="KIT.normaliseSchema: "+o+"’s ",s=t[r][o],u=a[r][o]={}
;u.name=o,u.default="object"===(void 0===s?"undefined":$traceurRuntime.typeof(s))?s.default:s
;var l={array:Array,boolean:Boolean,function:Function,
number:Number,object:Object,string:String,symbol:Symbol}
;if(s.hasOwnProperty("type"))if(l[s.type])u.type=l[s.type];else if({
undefined:1,color:1,int:1,null:1}[s.type])u.type=s.type;else{
if("function"!=typeof s.type)throw TypeError(i+"inDesc.type is not a string or a function")
;if(!s.type.name)throw TypeError(i+"inDesc.type has no name")
...
s.remarks&&(u.remarks=s.remarks)}return a}},t)
...
this.constructor.stat._inst_tally++},{reset:function(){
...
mixin:function(e){
var t="Oom.mixin(): ",a=this.schema,r=n.normaliseSchema(this,e)
;for(var o in this.schema={},
this.schema.stat=Object.assign({},a.stat,r.stat),this.schema.attr=Object.assign({},a.attr,r.attr),
this.stat={},this.schema.stat){var i=this.schema.stat[o]
;if(n.isConstant(o))n.define.constant.stat(this.stat,i);else if(n.isReadOnly(o))n.define.readOnly.stat(this.stat,i);else{
if(!n.isReadWrite(o))throw Error(t+o+" is an invalid static name")
;n.define.readWrite.stat(this.stat,i)}}
for(var s in this.prototype.attr={},this.schema.attr){
var u=this.schema.attr[s]
;if(n.isConstant(s))n.define.constant.attr(this.prototype.attr,u);else if(n.isReadOnly(s))n.define.readOnly.attr(this.prototype.attr,u);else{
if(!n.isReadWrite(s))throw Error(t+s+" is an invalid attribute name")
;n.define.readWrite.attr(this.prototype.attr,u)}}}})}():e.Oom
...
default:"#112233",type:"color"}},attr:{UUID:44,inst_index:0,
hilite:{
remarks:"General purpose, useful as a dev label or status",
...
},a.devMainAFrame=function(e){return{}},a.Foo=function(e){
...
}(a),n.name(a.Foo,"Oom.Foo"),a.Foo.mixin({
