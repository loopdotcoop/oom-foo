...
VERSION:"1.2.21",HOMEPAGE:"http://oom-foo.loop.coop/",
...
attr:function(e,t){if(t.isFn){var a=t.default()
;Object.defineProperty(e,t.name,{get:function(){return a},
set:function(e){},configurable:!0,enumerable:!0})
}else n.define.constant.any(e,t)},any:function(e,t){
return Object.defineProperty(e,t.name,{
value:t.isFn?t.default():t.default,configurable:!1,
enumerable:!0,writable:!1})}},readOnly:{stat:function(e,t){
...
;for(var t in e.attr)if(n.isConstant(t)){var a=e.attr[t]
;a.isFn&&n.define.constant.attr(this.attr,a)}
...
;this.schema={},this.schema.stat=Object.assign({},a.stat,r.stat),
this.schema.attr=Object.assign({},a.attr,r.attr)
;var i=this.stat={};for(var o in this.schema.stat){
var s=this.schema.stat[o]
;if(n.isConstant(o))n.define.constant.stat(i,s);else if(n.isReadOnly(o))n.define.readOnly.stat(i,s);else{
if(!n.isReadWrite(o))throw Error(t+o+" is an invalid static name")
;n.define.readWrite.stat(i,s)}}var u=this.prototype.attr={}
;for(var l in this.schema.attr){var c=this.schema.attr[l]
;if(n.isConstant(l))c.isFn||n.define.constant.attr(u,c);else if(n.isReadOnly(l))n.define.readOnly.attr(u,c);else{
if(!n.isReadWrite(l))throw Error(t+l+" is an invalid attribute name")
;n.define.readWrite.attr(u,c)}}}})}():e.Oom
...
default:"#112233",type:"color"}},attr:{UUID:n.generateUUID,
inst_index:0,hilite:{
remarks:"General purpose, useful as a dev label or status",
