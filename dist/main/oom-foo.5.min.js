...
VERSION:"1.2.24",HOMEPAGE:"http://oom-foo.loop.coop/",
...
normaliseSchema:function(e,t){var a={};for(var r in t){a[r]={}
;for(var i in t[r]){
...
string:String,symbol:Symbol},c={undefined:1,color:1,int:1,null:1
}
;if(s.hasOwnProperty("type"))if(l[s.type])u.type=l[s.type];else if(c[s.type])u.type=s.type;else{
...
function $__1(){var e=void 0!==arguments[0]?arguments[0]:{}
;$traceurRuntime.superConstructor($__1).call(this,e)}
return $traceurRuntime.createClass($__1,{},{},e)
...
function $__0(){var e=void 0!==arguments[0]?arguments[0]:{}
;$traceurRuntime.superConstructor($__0).call(this,e)}
return $traceurRuntime.createClass($__0,{},{},e)}(t.Foo)
;n.name(a,"Oom.Foo.Post"),t.Foo.Post.mixin({
...
;$traceurRuntime.superConstructor($__0).call(this,e)}
return $traceurRuntime.createClass($__0,{},{},e)}(t.Foo)
;n.name(a,"Oom.Foo.Router"),t.Foo.Router.mixin({
