...
u.definedIn=e,u.definedInStr=e.name,s.remarks&&(u.remarks=s.remarks)
}return a}},t)
}(t.LOADED_FIRST||!e.Oom.KIT?{}:e.Oom.KIT),a=e.Oom=t.LOADED_FIRST?function(){
return $traceurRuntime.createClass(function Oom(){
void 0!==arguments[0]&&arguments[0]
;Oom===this.constructor&&(this.attr._inst_index=Oom.stat.inst_tally,
Oom.stat._inst_tally++)},{reset:function(){
...
var t=this.schema,a=n.normaliseSchema(this,e)
;this.schema={},this.schema.stat=Object.assign({},t.stat,a.stat),
this.schema.attr=Object.assign({},t.attr,a.attr),
this.stat={},n.define(this.stat,!0,this.schema.stat),
this.prototype.attr={},n.define(this.prototype.attr,!1,this.schema.attr)
}})}():e.Oom
;n.name(a,"Oom"),a.KIT=n,t.LOADED_FIRST&&(a.schema={},a.mixin({
location:"src/main/Bases.6.js:122",title:"The Base Schema",
remarks:"The foundational schema, defined by the base Oom class",
config:{},stat:{NAME:"Oom",VERSION:t.VERSION,
...
},{},{},e)}(a),n.name(a.Foo,"Oom.Foo"),a.Foo.mixin({
location:"src/main/Bases.6.js:299",title:"The Oom.Foo Schema",
remarks:"Defines metadata for this module",config:{},stat:t,
attr:{}})
...
remarks:"Defines metadata for this module",config:{},stat:{
