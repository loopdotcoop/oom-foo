...
Vue.component('oom-base-sub', {
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Foo.El.Hero.
  , beforeCreate: function () {
        inners.push( new ROOT.Oom.Foo.El.Hero({
  ...
  , created: function () {
        wrapApiGettersAndSetters(outers[outers.length-1])
        wrapApiGettersAndSetters(ROOT.Oom.Foo.El.Hero)
    }
})
