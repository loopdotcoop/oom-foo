...
Vue.component('oom-base-sub', {
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Foo.Plain.
  , beforeCreate: function () {
        inners.push( new ROOT.Oom.Foo.Plain({
  ...
  , created: function () {
        wrapApiGettersAndSetters(outers[outers.length-1])
        wrapApiGettersAndSetters(ROOT.Oom.Foo.Plain)
    }
})
