//\\//\\ src/demo/ElMix.FooBar-demo.6.js
...
//// Register <oom-base-sub>, a Vue component version of Oom.Foo.ElMix.FooBar.
Vue.component('oom-base-sub', {
    template: template.oomBaseSub.innerHTML
  , data: function () { return {
        instance: inners[inners.length-1].api
      , static: ROOT.Oom.Foo.ElMix.FooBar.api
      , ui: { hideData:false }
    } }
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Foo.ElMix.FooBar.
  , beforeCreate: function () {
        inners.push( new ROOT.Oom.Foo.ElMix.FooBar({
  ...
  , created: function () {
        wrapApiGettersAndSetters(outers[outers.length-1])
        wrapApiGettersAndSetters(ROOT.Oom.Foo.ElMix.FooBar)
    }
})
