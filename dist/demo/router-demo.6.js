...
Vue.component('oom-base-sub', {
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Foo.Router.
  , beforeCreate: function () {
        inners.push( new ROOT.Oom.Foo.Router({
  ...
  , created: function () {
        wrapApiGettersAndSetters(outers[outers.length-1])
        wrapApiGettersAndSetters(ROOT.Oom.Foo.Router)
    }
})
