//\\//\\ src/demo/ElMix.FooBar.Sub-demo.6.js
...
<div class="oom-component container">
  ...
  <!-- Composition - other instances contained in this Oom.Foo instance -->
...
//// Register 'oomfoo', an A-Frame component version of Oom.Foo.
AFRAME.registerComponent('oomfoo', {
    schema: apiToAframeSchema(ROOT.Oom.Foo.api)
  , init: function () {}
...
Vue.component('oom-demo', {
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Foo.
  , beforeCreate: function () {
        outers.push( new ROOT.Oom.Foo({
  ...
  , created: function () {
        ...
        wrapApiGettersAndSetters(ROOT.Oom.Foo)
    }

})


//// Register <a-oomfoo-wrap>, to tell Vue about the A-Frame primative for Oom.Foo.
...
//// Register <oom-base-sub>, a Vue component version of Oom.Foo.ElMix.FooBar.Sub.
Vue.component('oom-base-sub', {
    template: template.oomBaseSub.innerHTML
  , data: function () { return {
        instance: inners[inners.length-1].api
      , static: ROOT.Oom.Foo.ElMix.FooBar.Sub.api
      , ui: { hideData:false }
    } }
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Foo.ElMix.FooBar.Sub.
  , beforeCreate: function () {
        inners.push( new ROOT.Oom.Foo.ElMix.FooBar.Sub({
  ...
  , created: function () {
        wrapApiGettersAndSetters(outers[outers.length-1])
        wrapApiGettersAndSetters(ROOT.Oom.Foo.ElMix.FooBar.Sub)
    }
})
