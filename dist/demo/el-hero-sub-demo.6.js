//\\//\\ src/demo/El.Hero.Sub-demo.6.js
...
//// Register <oom-base-sub>, a Vue component version of Oom.Foo.El.Hero.Sub.
Vue.component('oom-base-sub', {
    template: template.oomBaseSub.innerHTML
  , data: function () { return {
        instance: inners[inners.length-1].api
      , static: ROOT.Oom.Foo.El.Hero.Sub.api
      , ui: { hideData:false }
    } }
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Foo.El.Hero.Sub.
  , beforeCreate: function () {
        inners.push( new ROOT.Oom.Foo.El.Hero.Sub({
  ...
  , created: function () {
        wrapApiGettersAndSetters(outers[outers.length-1])
        wrapApiGettersAndSetters(ROOT.Oom.Foo.El.Hero.Sub)
    }
})
