...
//// Register <oom-base-sub>, a Vue component version of Oom.Foo.Plain.Sub.
Vue.component('oom-base-sub', {
    template: template.oomBaseSub.innerHTML
  , data: function () { return {
        instance: inners[inners.length-1].api
      , static: ROOT.Oom.Foo.Plain.Sub.api
      , ui: { hideData:false }
    } }
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Foo.Plain.Sub.
  , beforeCreate: function () {
        inners.push( new ROOT.Oom.Foo.Plain.Sub({
  ...
  , created: function () {
        wrapApiGettersAndSetters(outers[outers.length-1])
        wrapApiGettersAndSetters(ROOT.Oom.Foo.Plain.Sub)
    }
})
