...
Vue.component('oom-base-sub', {
  ...
  , methods: {
    ...
    //// Generate an instance of Oom.Foo.Mix.Red.
  , beforeCreate: function () {
        inners.push( new ROOT.Oom.Foo.Mix.Red({
  ...
  , created: function () {
        wrapApiGettersAndSetters(outers[outers.length-1])
        wrapApiGettersAndSetters(ROOT.Oom.Foo.Mix.Red)
    }
})
