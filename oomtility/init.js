...
22. support/asset/js/jquery-3.1.1.min.js      Cross-browser JS helpers
...
const projectV    = '1.0.1' // NPM does not update a '0.*.*' version
...
function createFiles () {
    ...
    //// 22. support/asset/js/jquery-3.1.1.min.js      Cross-browser JS helpers
    fs.writeFileSync('support/asset/js/jquery-3.1.1.min.js', getJquery311MinJs())
