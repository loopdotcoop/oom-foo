...
-k  --kitchen-sink  Run --remove, and then init, make and test a standard repo
...
//// Declare variables.
let opt, remove = false, yeslessRemove, projectDesc, projectColor, kitchenSink
...
function doKitchenSink () {
    console.log(NAME+' will replace current repo with the ‘kitchen sink’...')
