...
8.  support/asset/icon/android-256x256.png    Larger icon for Android
9.  support/asset/icon/apple-touch.png        Icon for iOS
10. support/asset/icon/browserconfig.xml      Configures Windows Metro
11. support/asset/icon/favicon32.png          Icon for modern browsers
12. support/asset/icon/favicon16.png          Icon for modern browsers
13. support/asset/icon/favicon.ico            Icon for legacy browsers
14. support/asset/icon/manifest.json          Configures Android
15. support/asset/icon/mstile-150x150.png     Icon for Windows Metro
16. support/asset/icon/safari-pinned-tab.svg  Icon for mobile Safari
17. support/asset/font/podkova.woff2          Custom Google font
18. support/asset/js/ecmaswitch.js            Switch between JS builds
19. support/asset/js/klud.min.js              An assertion library
20. support/asset/js/report.min.js            Klud’s reporter
21. support/asset/js/polyfill.min.js          Support Object.assign
22. support/asset/js/jquery-3.2.1.slim.min.js Cross-browser JS helpers
23. support/asset/js/traceur-runtime.min.js   Runs ES6 transpiled to ES5
24. support/asset/logo/logo1200.png           Main image on homepage
25. .gitignore                                Ignore .DS_Store, etc
26. CHANGELOG                                 Lists bumps and commits
27. CNAME                                     Sets the homepage URL
28. index.html                                The repo homepage
29. package.json                              For publishing on NPM
30. README.md                                 Human-readable repo info
...
const projectV    = '1.0.2' // NPM does not update a '0.*.*' version
...
function createFiles () {
    ...
    //// 5.  support/asset/css/bootstrap.min.css       Grid, normalise browsers
    // fs.writeFileSync('support/asset/css/bootstrap.min.css', getBootstrapMinCss())

    //// 6.  support/asset/css/main.css                Specific Oom styles
    // fs.writeFileSync('support/asset/js/support/asset/css/main.css', getMainCSS())

    //// 7.  support/asset/icon/android-192x192.png    Smaller icon for Android
    // fs.writeFileSync('support/asset/icon/android-192x192.png', getAndroid192x192Png())

    //// 8.  support/asset/icon/android-256x256.png    Larger icon for Android
    // fs.writeFileSync('support/asset/icon/android-256x256.png', getAndroid256x256Png())

    //// 9.  support/asset/icon/apple-touch.png        Icon for iOS
    // fs.writeFileSync('support/asset/icon/apple-touch.png', getAppleTouchPng())

    //// 10. support/asset/icon/browserconfig.xml      Configures Windows Metro
    // fs.writeFileSync('support/asset/icon/browserconfig.xml', getBrowserconfigXml())

    //// 11. support/asset/icon/favicon32.png          Icon for modern browsers
    // fs.writeFileSync('support/asset/icon/favicon32.png', getFavicon32Png())

    //// 12. support/asset/icon/favicon16.png          Icon for modern browsers
    // fs.writeFileSync('support/asset/icon/favicon16.png', getFavicon16Png())

    //// 13. support/asset/icon/favicon.ico            Icon for legacy browsers
    // fs.writeFileSync('support/asset/icon/favicon.ico', getFaviconIco())

    //// 14. support/asset/icon/manifest.json          Configures Android
    // fs.writeFileSync('support/asset/icon/manifest.json', getManifestJson())

    //// 15. support/asset/icon/mstile-150x150.png     Icon for Windows Metro
    // fs.writeFileSync('support/asset/icon/mstile-150x150.png', getMstile150x150Png())

    //// 16. support/asset/icon/safari-pinned-tab.svg  Icon for mobile Safari
    // fs.writeFileSync('support/asset/icon/safari-pinned-tab.svg', getSafariPinnedTabSvg())

    //// 17. support/asset/font/podkova.woff2          Custom Google font
    // fs.writeFileSync('support/asset/font/podkova.woff2', getPodkovaWoff2())

    //// 18. support/asset/js/ecmaswitch.js            Switch between JS builds
    fs.writeFileSync('support/asset/js/ecmaswitch.js', getEcmaswitchJs())

    //// 19. support/asset/js/klud.min.js              An assertion library
    fs.writeFileSync('support/asset/js/klud.min.js', getKludMinJs())

    //// 20. support/asset/js/report.min.js            Klud’s reporter
    fs.writeFileSync('support/asset/js/report.min.js', getReportMinJs())

    //// 21. support/asset/js/polyfill.min.js          Support Object.assign
    fs.writeFileSync('support/asset/js/polyfill.min.js', getPolyfillMinJs())

    //// 22. support/asset/js/jquery-3.2.1.slim.min.js Cross-browser JS helpers
    fs.writeFileSync('support/asset/js/jquery-3.2.1.slim.min.js', getJquery321SlimMinJs())

    //// 23. support/asset/js/traceur-runtime.min.js   Runs ES6 transpiled to ES5
    fs.writeFileSync('support/asset/js/traceur-runtime.min.js', getTraceurRuntimeMinJs())

    //// 24. support/asset/logo/logo1200.png           Main image on homepage
    // fs.writeFileSync('support/asset/logo/logo1200.png', getLogo1200Png())
